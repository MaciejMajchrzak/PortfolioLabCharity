    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategorysDonations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategorysDonations_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategorysDonations_Donations_DontaionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategorysDonations_CategoryId",
                table: "CategorysDonations",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CategorysDonations_DontaionId",
                table: "CategorysDonations",
                column: "DontaionId");
